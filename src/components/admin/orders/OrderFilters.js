  ...
  return (
    <section className="order-filters" aria-label="Order filters">
      ...
      <div className="order-filter-control-grid">
        <label><span>Order status</span><select value={filters.status} onChange={(event) => setField("status", event.target.value)}>
        ...
        <label><span>Payment status</span><select value={filters.paymentStatus} onChange={(event) => setField("paymentStatus", event.target.value)}>
        ...
        <label><span>Fulfillment</span><select value={filters.fulfillmentType} onChange={(event) => setField("fulfillmentType", event.target.value)}>
        ...
        <label><span>Payment method</span><select value={filters.paymentMethod} onChange={(event) => setField("paymentMethod", event.target.value)}>
